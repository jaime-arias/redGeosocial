...
<head>
  <meta charset="utf-8">
  <meta name="author" content="Jaime Arias e Iván de Santiago">
  <title>Alistensee | Registro</title>
...
<body>
  ...
  <header>
    <div class="container">
      <div id="branding">
        <h1><span class="highlight">aListen</span>See</h1>
      </div>
      <nav>
        <ul>
          <li class="current"><a href="../index.html">Página principal</a></li>
          <li><a href="../pages/signup.php">Registrarse</a></li>
        </ul>
      </nav>
    </div>
  </header>
  <section id="showcase">
    <div id="login_div" class="form">
      <form class="login-form">
        ...
        <input type="text" placeholder="Ingresa tu correo electrónico" name="email" required>
        ...
        <label for="genre"><b>Indica tu género<br></b></label>
        ...
        <label for="fecNac"><b>Ingresa tu fecha de nacimiento</b></label>
        <div class="controls">
        ...
        <hr>
        <p>Al crear una cuenta, estas aceptando nuestros términos y condiciones. <a href="#">Términos y condiciones.</a>.</p>
        <button type="submit" class="registerbtn">Registrar</button>
      </form>
    </div>
  </section>
  <footer>
    <p>DreamTeam, 2019 <a href="/index.html">Términos y condiciones.</a></li>
    </p>
  </footer>
</body>
